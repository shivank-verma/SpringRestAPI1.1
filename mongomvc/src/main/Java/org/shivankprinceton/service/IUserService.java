...
public static final String COLLECTION_NAME = "user";
	...
	Update update = new Update().set("user_id",user.getUser_id()).set("email", user.getEmail()).set("comment", user.getComment()).set("name", user.getName()).set("phn_no", user.getphn_no());
		mongoTemplate.findAndModify(queryupdate, update, User.class, COLLECTION_NAME);*/
